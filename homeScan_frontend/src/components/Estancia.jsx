...
import { Wifi, Bluetooth, Network, Radio, Plug, Cable, Trash2, Eye } from "lucide-react"
import { FaEye } from "react-icons/fa"
import { useNavigate } from "react-router-dom"

export default function Estancia({ estancia, onDelete, modoOscuro, vista }) {
    const isVistaColumna = vista === "columna";
    ...
    return (
        <div style={styles.card} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            ...
            <div style={styles.buttonContainer}>
                ...
                >
                    <Eye size={isVistaColumna ? 24 : 20} style={{ color: theme.accent, display: "block" }} />
                </button>
                <button
                    className="button-hover"
                ...
                >
                    <Trash2 size={20} style={{ color: theme.danger }} />
                </button>
            </div>
        </div>
    )
